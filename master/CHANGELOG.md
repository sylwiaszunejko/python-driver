...
* MontonicTimestampGenerator._\_init_\_ ignores class defaults (PYTHON-728)
...
* Exception when use pk_\_token_\_gt filter In python 3.7 (PYTHON-1121)
...
* \_\_del_\_ method in Session is throwing an exception (PYTHON-813)
...
* implement \_\_le_\_/_\_ge_\_/_\_ne_\_ on some custom types (PYTHON-714)
...
* Add \_\_len_\_ to BatchStatement (PYTHON-650)
...
* cqlengine: pk_\_token column name issue with the equality operator (PYTHON-584)
* cqlengine: Fix “_\_in” filtering operator converts True to string “True” automatically (PYTHON-596)
...
* cqlengine: Typo in cqlengine UserType \_\_len_\_ breaks attribute assignment (PYTHON-502)
...
* Add cql_version kwarg to Cluster._\_init_\_
...
* Add \_\_repr_\_ method for Statement classes
