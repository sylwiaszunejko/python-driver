...
instances of a class or a dict by registering them with your [`Cluster`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster)
instance through [`Cluster.register_user_type()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.register_user_type):
...
[`Cluster.register_user_type()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cluster.md#cassandra.cluster.Cluster.register_user_type), the driver gives you some options
