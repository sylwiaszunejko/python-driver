...
For pertinent execution parameters, see [`Statement.serial_consistency_level`](https://python-driver.docs.scylladb.com/master/api/cassandra/query.md#cassandra.query.Statement.serial_consistency_level).
