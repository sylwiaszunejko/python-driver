...
A model is a python class representing a CQL table. Models derive from `Model`, and
...
Some basic examples defining models are shown below. Consult the [Model API docs](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/models.md) and [Column API docs](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/columns.md) for complete details.
...
Please see the discussion in [cassandra.cqlengine.management](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/management.md) for considerations.

For examples on manipulating data and creating queries, see [Making Queries](https://python-driver.docs.scylladb.com/master/cqlengine/queryset.md)
...
UDTs are modeled by inheriting [`UserType`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/usertype.md#cassandra.cqlengine.usertype.UserType), and setting column type attributes. Types are then used in defining
models by declaring a column of type [`UserDefinedType`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/columns.md#cassandra.cqlengine.columns.UserDefinedType), with the `UserType` class as a parameter.

`sync_table` will implicitly
synchronize any types contained in the table. Alternatively [`sync_type()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/management.md#cassandra.cqlengine.management.sync_type) can be used to create/alter types
explicitly.
