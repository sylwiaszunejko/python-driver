...
<a id="retrieving-objects-with-filters"></a>
...
<a id="query-filtering-operators"></a>
...
Token functon may be used only on special, virtual column pk_\_token, representing token of partition key (it also works for composite partition keys).
...
See [http://cassandra.apache.org/doc/cql3/CQL-3.0.html#tokenFun](http://cassandra.apache.org/doc/cql3/CQL-3.0.html#tokenFun)
