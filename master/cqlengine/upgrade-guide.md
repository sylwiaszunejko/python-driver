...
reversed ([CASSANDRA-8733](https://issues.apache.org/jira/browse/CASSANDRA-8733)). As of
...
Going forward, the [`Date`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/columns.md#cassandra.cqlengine.columns.Date) type represents a `date` for Cassandra 2.2+
([PYTHON-245](https://datastax-oss.atlassian.net/browse/PYTHON-245)).
Users of the legacy functionality should convert models to use [`DateTime`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/columns.md#cassandra.cqlengine.columns.DateTime) (which
...
[`cassandra.ConsistencyLevel`](https://python-driver.docs.scylladb.com/master/api/cassandra.md#cassandra.ConsistencyLevel) remains.
...
This inititializer parameter is now deprecated. Applications should use [`Double`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/columns.md#cassandra.cqlengine.columns.Double) for CQL `double`, and [`Float`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/columns.md#cassandra.cqlengine.columns.Float)
for CQL `float`.
...
- [`create_keyspace_simple()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/management.md#cassandra.cqlengine.management.create_keyspace_simple)
- [`create_keyspace_network_topology()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/management.md#cassandra.cqlengine.management.create_keyspace_network_topology)

`cassandra.cqlengine.management.delete_keyspace` is deprecated in favor of a new function, [`drop_keyspace()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/management.md#cassandra.cqlengine.management.drop_keyspace). The
...
- Replace ‘polymorphic_key’ in the base class Column definition with [`discriminator_column`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/columns.md#cassandra.cqlengine.columns.Column.discriminator_column)
- Replace the ‘_\_polymorphic_key_\_’ class attribute the derived classes with [`__discriminator_value__`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/models.md#cassandra.cqlengine.models.Model.__discriminator_value__)
...
This function is deprecated in favor of the core utility function [`uuid_from_time()`](https://python-driver.docs.scylladb.com/master/api/cassandra/util.md#cassandra.util.uuid_from_time).
