...
To use cqlengine, you need at least a default connection. If you initialize cqlengine’s connections with with [`connection.setup`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/connection.md#cassandra.cqlengine.connection.setup), a connection will be created automatically. If you want to use another cluster/session, you need to register a new cqlengine connection. You register a connection with [`register_connection()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/connection.md#cassandra.cqlengine.connection.register_connection):
...
[`register_connection()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/connection.md#cassandra.cqlengine.connection.register_connection) can take a list of hosts, as shown above, in which case it will create a connection with a new session. It can also take a session argument if you’ve already created a session:
...
or on the fly using [`set_default_connection()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/connection.md#cassandra.cqlengine.connection.set_default_connection)
...
You can unregister a connection using [`unregister_connection()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/connection.md#cassandra.cqlengine.connection.unregister_connection):
...
You can use the [`using()`](https://python-driver.docs.scylladb.com/master/api/cassandra/cqlengine/query.md#cassandra.cqlengine.query.ModelQuerySet.using) method to select a connection (or keyspace):
